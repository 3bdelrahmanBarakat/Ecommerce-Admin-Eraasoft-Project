...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المنتاجات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                    المنتاجات</span>
            </div>
        </div>
                            ...
                            <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0"> لون المنتج</th>
                                        <th class="border-bottom-0">السعر</th>
                                        <th class="border-bottom-0">الماركه</th>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu tx-13">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href=" {{ url('edit_product') }}/{{ $product->id }}">تعديل
                                                            المنتج</a>



                                                        <a class="dropdown-item" href="#"
                                                            data-product_id="{{ $product->id }}" data-toggle="modal"
