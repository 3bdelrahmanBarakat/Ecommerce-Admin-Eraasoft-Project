            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/faces/3135715.png') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{ URL::asset('assets/img/faces/3135715.png') }}"
                                        class=""></div>
                        ...
                        <a class="dropdown-item" href="/home">الرئيسية</a>
                        <a class="dropdown-item" href="/products">المنتاجات</a>
                        <a class="dropdown-item" href="/orders">الاوردارات</a>
