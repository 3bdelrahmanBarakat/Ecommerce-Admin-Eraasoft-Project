...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'home')) }}"><h3>MaleFashion</h3></a>
    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/3135715.png') }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = 'products')) }}">
                        <span class="side-menu__label">المنتاجات</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'products')) }}">قائمة المنتاجات</a></li>

                    </ul>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = 'orders')) }}">
                        <span class="side-menu__label">الاوردارات</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'orders')) }}">قائمة الاوردارات</a></li>
